...
SMTP_FROM_EMAIL = os.environ.get("SMTP_FROM_EMAIL", "davide@afianco.ch")
SMTP_FROM_NAME = os.environ.get("SMTP_FROM_NAME", "AFianco")
...
EMAIL_TRANSLATIONS = {
    "it": {
        ...
        "footer_brand": "AFianco — Gestione finanziaria per PMI",
        ...
        "invite_request_confirm_subject": "Candidatura ricevuta — AFianco",
        "invite_request_confirm_body": "Abbiamo ricevuto la tua richiesta di accesso ad AFianco.",
        "invite_request_confirm_next": "Ti contatteremo al piu presto per fornirti l'accesso.",
        # Welcome / verify
        "welcome_subject": "Benvenuto su AFianco — Verifica la tua email",
        "welcome_subject_no_token": "Benvenuto su AFianco!",
        "welcome_body": "Benvenuto su AFianco! Il tuo account e' stato creato con successo.",
        ...
        "welcome_no_token_cta": "Accedi ad AFianco",
        "welcome_expiry": "Il link scade tra <strong>24 ore</strong>.",
        # Verification (resend)
        "verify_subject": "Verifica il tuo indirizzo email — AFianco",
        ...
        # Password reset
        "reset_subject": "Reimposta la tua password — AFianco",
        ...
        # Password changed
        "changed_subject": "Password modificata — AFianco",
        ...
        "lockout_alert_subject": "Tentativi sospetti sul tuo account AFianco",
        ...
        # Team invite
        "team_subject": "Sei stato invitato su AFianco — {org_name}",
        "team_body": "<strong>{inviter}</strong> ti ha invitato a unirti a <strong>{org_name}</strong> su AFianco.",
        "team_credentials": "Le tue credenziali temporanee:",
        "team_cta": "Accedi ad AFianco",
        "team_change_password": "<strong>Ti consigliamo di cambiare la password al primo accesso.</strong>",
        # Deactivation
        "deactivation_subject": "Account AFianco disattivato — {org_name}",
        "deactivation_body": "L'account dell'organizzazione <strong>{org_name}</strong> su AFianco e' stato disattivato.",
        ...
        # Platform invite
        "platform_invite_subject": "Sei stato invitato su AFianco",
        "platform_invite_body": "Sei stato invitato a registrarti su <strong>AFianco</strong>, la piattaforma di gestione finanziaria per PMI.",
        "platform_invite_cta_label": "Clicca il pulsante qui sotto per creare il tuo account:",
        "platform_invite_cta": "Registrati su AFianco",
    ...
    "en": {
        ...
        "footer_brand": "AFianco — Financial management for SMEs",
        "footer_auto": "This email was sent automatically, please do not reply.",
        "footer_reply_to": "To reply, write to {email}.",
        "invite_request_confirm_subject": "Application received — AFianco",
        "invite_request_confirm_body": "We have received your request to access AFianco.",
        "invite_request_confirm_next": "We will contact you as soon as possible to provide you with access.",
        "welcome_subject": "Welcome to AFianco — Verify your email",
        "welcome_subject_no_token": "Welcome to AFianco!",
        "welcome_body": "Welcome to AFianco! Your account has been created successfully.",
        ...
        "welcome_no_token_cta": "Sign in to AFianco",
        "welcome_expiry": "The link expires in <strong>24 hours</strong>.",
        "verify_subject": "Verify your email address — AFianco",
        ...
        "reset_subject": "Reset your password — AFianco",
        ...
        "changed_subject": "Password changed — AFianco",
        ...
        "lockout_alert_subject": "Suspicious activity on your AFianco account",
        ...
        "team_subject": "You've been invited to AFianco — {org_name}",
        "team_body": "<strong>{inviter}</strong> has invited you to join <strong>{org_name}</strong> on AFianco.",
        "team_credentials": "Your temporary credentials:",
        "team_cta": "Sign in to AFianco",
        "team_change_password": "<strong>We recommend changing your password on first login.</strong>",
        "deactivation_subject": "AFianco account deactivated — {org_name}",
        "deactivation_body": "The organization account <strong>{org_name}</strong> on AFianco has been deactivated.",
        ...
        "platform_invite_subject": "You've been invited to AFianco",
        "platform_invite_body": "You've been invited to sign up on <strong>AFianco</strong>, the financial management platform for SMEs.",
        "platform_invite_cta_label": "Click the button below to create your account:",
        "platform_invite_cta": "Sign up for AFianco",
    ...
    "de": {
        ...
        "footer_brand": "AFianco — Finanzmanagement fuer KMU",
        ...
        "invite_request_confirm_subject": "Bewerbung eingegangen — AFianco",
        "invite_request_confirm_body": "Wir haben Ihre Zugriffsanfrage fuer AFianco erhalten.",
        "invite_request_confirm_next": "Wir werden Sie so schnell wie moeglich kontaktieren, um Ihnen den Zugang zu ermoeglichen.",
        "welcome_subject": "Willkommen bei AFianco — Bestaetigen Sie Ihre E-Mail",
        "welcome_subject_no_token": "Willkommen bei AFianco!",
        "welcome_body": "Willkommen bei AFianco! Ihr Konto wurde erfolgreich erstellt.",
        ...
        "welcome_no_token_cta": "Bei AFianco anmelden",
        "welcome_expiry": "Der Link laeuft in <strong>24 Stunden</strong> ab.",
        "verify_subject": "Bestaetigen Sie Ihre E-Mail-Adresse — AFianco",
        ...
        "reset_subject": "Passwort zuruecksetzen — AFianco",
        ...
        "changed_subject": "Passwort geaendert — AFianco",
        ...
        "lockout_alert_subject": "Verdaechtige Aktivitaet auf Ihrem AFianco-Konto",
        ...
        "team_subject": "Sie wurden zu AFianco eingeladen — {org_name}",
        "team_body": "<strong>{inviter}</strong> hat Sie eingeladen, <strong>{org_name}</strong> auf AFianco beizutreten.",
        "team_credentials": "Ihre temporaeren Zugangsdaten:",
        "team_cta": "Bei AFianco anmelden",
        "team_change_password": "<strong>Wir empfehlen, Ihr Passwort beim ersten Login zu aendern.</strong>",
        "deactivation_subject": "AFianco-Konto deaktiviert — {org_name}",
        "deactivation_body": "Das Organisationskonto <strong>{org_name}</strong> auf AFianco wurde deaktiviert.",
        ...
        "platform_invite_subject": "Sie wurden zu AFianco eingeladen",
        "platform_invite_body": "Sie wurden eingeladen, sich bei <strong>AFianco</strong> zu registrieren, der Finanzmanagement-Plattform fuer KMU.",
        "platform_invite_cta_label": "Klicken Sie auf die Schaltflaeche unten, um Ihr Konto zu erstellen:",
        "platform_invite_cta": "Bei AFianco registrieren",
    ...
    "fr": {
        ...
        "footer_brand": "AFianco — Gestion financiere pour PME",
        "footer_auto": "Cet email a ete envoye automatiquement, merci de ne pas repondre.",
        "footer_reply_to": "Pour repondre, ecrivez a {email}.",
        "invite_request_confirm_subject": "Candidature recue — AFianco",
        "invite_request_confirm_body": "Nous avons recu votre demande d'acces a AFianco.",
        "invite_request_confirm_next": "Nous vous contacterons dans les plus brefs delais pour vous fournir l'acces.",
        "welcome_subject": "Bienvenue sur AFianco — Verifiez votre email",
        "welcome_subject_no_token": "Bienvenue sur AFianco !",
        "welcome_body": "Bienvenue sur AFianco ! Votre compte a ete cree avec succes.",
        ...
        "welcome_no_token_cta": "Se connecter a AFianco",
        "welcome_expiry": "Le lien expire dans <strong>24 heures</strong>.",
        "verify_subject": "Verifiez votre adresse email — AFianco",
        ...
        "reset_subject": "Reinitialiser votre mot de passe — AFianco",
        ...
        "changed_subject": "Mot de passe modifie — AFianco",
        ...
        "lockout_alert_subject": "Activite suspecte sur votre compte AFianco",
        ...
        "team_subject": "Vous avez ete invite sur AFianco — {org_name}",
        "team_body": "<strong>{inviter}</strong> vous a invite a rejoindre <strong>{org_name}</strong> sur AFianco.",
        "team_credentials": "Vos identifiants temporaires :",
        "team_cta": "Se connecter a AFianco",
        "team_change_password": "<strong>Nous vous recommandons de changer votre mot de passe lors de votre premiere connexion.</strong>",
        "deactivation_subject": "Compte AFianco desactive — {org_name}",
        "deactivation_body": "Le compte de l'organisation <strong>{org_name}</strong> sur AFianco a ete desactive.",
        ...
        "platform_invite_subject": "Vous avez ete invite sur AFianco",
        "platform_invite_body": "Vous avez ete invite a vous inscrire sur <strong>AFianco</strong>, la plateforme de gestion financiere pour PME.",
        "platform_invite_cta_label": "Cliquez sur le bouton ci-dessous pour creer votre compte :",
        "platform_invite_cta": "S'inscrire sur AFianco",
...
def _wrap_template(content: str, locale: str = "it", *, reply_to: str = None, store_name: str = None) -> str:
    ...
    if store_name:
        header_html = f'<h1>{store_name}</h1><p style="margin:4px 0 0;font-size:12px;color:rgba(255,255,255,0.7);">via AFianco</p>'
    else:
        header_html = '<h1>AFianco</h1>'
...
def send_platform_invite(to_email: str, invite_url: str, locale: str = "it") -> bool:
    """Invite a new user to sign up on AFianco (platform-level, by system admin)."""
...
def send_invite_request_notification(name: str, email: str, business: str) -> bool:
    ...
    html = _wrap_template(f"""
        <p>Nuova candidatura ricevuta su AFianco:</p>
        <p>
    ...
    """, "it")
    return send_email(ADMIN_EMAIL, f"Nuova candidatura AFianco — {name}", html)
