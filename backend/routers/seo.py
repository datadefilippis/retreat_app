...
async def build_core() -> str:
    ...
    urls = [
        ...
        *[_url(f"{base}/sound/esplora/{slug}", priority="0.5")
        ...
        _url(f"{base}/sound/lab/ritratto", priority="0.4"),
        _url(f"{base}/sound/lab/meraviglie", priority="0.4"),
        _url(f"{base}/sound/lab/risonanze", priority="0.4"),
        _url(f"{base}/sound/professional", priority="0.7"),
        _url(f"{base}/sound/studio", priority="0.7"),
