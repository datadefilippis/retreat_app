...
## 8. Account, credentials, security
...
## 11. Service availability (best-effort SLA)
...
## 15. Provider's intellectual property
...
The Provider grants the User a license that is:
- Non-exclusive
- Non-transferable
- Limited to the duration of the contract
