...
- Le credenziali risultino gia' associate a un account preesistente disattivato per violazione dei Termini
- Sussistano provvedimenti di autorita' competenti
...
## 8. Account, credenziali, sicurezza

### 8.1 Riservatezza delle credenziali

L'Utente e' responsabile della riservatezza delle proprie credenziali di accesso. Tutte le attivita' compiute attraverso il proprio account sono attribuite all'Utente.

### 8.2 Requisiti minimi delle password

La password deve rispettare i requisiti tecnici imposti dalla Piattaforma (almeno 12 caratteri, contenenti lettere maiuscole, minuscole e cifre).
...
## 11. Disponibilita' del Servizio (SLA best-effort)

### 11.1 Impegno

Il Fornitore si impegna a garantire una elevata continuita' del Servizio, monitorando attivamente l'infrastruttura e i sub-responsabili.
...
Le manutenzioni programmate vengono pianificate fuori orario lavorativo standard CET e annunciate con almeno 48 ore di preavviso tramite avviso nella Piattaforma, salvo interventi urgenti di sicurezza.

### 11.4 Force majeure

Il Fornitore non e' responsabile per inadempimenti dovuti a cause di forza maggiore (calamita' naturali, atti governativi, scioperi, attacchi informatici massivi, indisponibilita' di sub-responsabili al di fuori del controllo del Fornitore).

---

## 12. Utilizzo accettabile
...
## 15. Proprieta' intellettuale del Fornitore
...
Il Fornitore concede all'Utente una licenza:
- Non esclusiva
- Non trasferibile
- Limitata alla durata del contratto
- Per l'uso del Servizio nelle modalita' previste dai Termini

L'Utente non acquisisce alcun diritto sulla Piattaforma al di fuori della licenza d'uso.

### 15.3 Feedback

Qualsiasi suggerimento, idea, segnalazione, miglioramento proposto dall'Utente in relazione alla Piattaforma puo' essere utilizzato dal Fornitore liberamente, senza alcun obbligo di compenso, attribuzione o riservatezza.

---

## 16. Limitazione di responsabilita'

### 16.1 Esclusione di garanzie implicite

Nella misura massima consentita dalla legge applicabile, il Fornitore esclude qualsiasi garanzia implicita di commerciabilita', idoneita' a un uso particolare, accuratezza dei risultati ottenibili.
...
Le Parti si impegnano a mantenere riservate le informazioni confidenziali ricevute dalla controparte nell'ambito del rapporto contrattuale, salvo quanto richiesto da:
- Autorita' giudiziarie o amministrative competenti
- Adempimenti fiscali e contabili obbligatori
- Esecuzione del Servizio (es. sub-responsabili autorizzati)

L'obbligo di riservatezza sopravvive alla cessazione del rapporto contrattuale per ulteriori **3 anni**.

---

## 19. Comunicazioni

### 19.1 Notifiche del Fornitore all'Utente

Le comunicazioni del Fornitore avvengono via email all'indirizzo registrato dall'Utente. L'Utente e' tenuto a mantenere aggiornato il proprio indirizzo email.
...
### 20.2 Modifiche minori

Per modifiche minori (correzioni di refusi, riformulazioni che non alterino la sostanza, aggiornamento di dati di contatto), il preavviso e' di **15 giorni**.

### 20.3 Modifiche urgenti

Per modifiche imposte da norme imperative di legge o da provvedimenti di autorita' competenti, il Fornitore puo' implementare le modifiche con effetto immediato, con successiva comunicazione all'Utente.

---

## 21. Cessione e subcontratto

### 21.1 Cessione del contratto

L'Utente non puo' cedere a terzi il proprio account o i diritti derivanti dal presente contratto senza il consenso scritto del Fornitore.

### 21.2 Cessione da parte del Fornitore

Il Fornitore puo' cedere il contratto a terzi nell'ambito di operazioni straordinarie (fusione, scissione, cessione d'azienda) con preavviso di 30 giorni. L'Utente avra' facolta' di recedere nel termine di preavviso.

### 21.3 Sub-responsabili

L'utilizzo di sub-responsabili da parte del Fornitore e' disciplinato dalla Privacy Policy art. 6.
...
I presenti Termini sono regolati esclusivamente dal **diritto svizzero**, con esclusione delle norme di conflitto e della Convenzione di Vienna del 1980 sui contratti di vendita internazionale di merci (CISG).

### 22.2 Foro competente

Per qualsiasi controversia derivante dai presenti Termini o dall'utilizzo del Servizio, le Parti convengono la **competenza esclusiva del foro di Lugano**, Svizzera.
...
I presenti Termini, unitamente alla Privacy Policy e all'eventuale Data Processing Agreement, costituiscono l'**intero accordo** tra le Parti in relazione al Servizio, sostituendo ogni precedente intesa scritta o verbale.

### 23.2 Separabilita' (severability)

Qualora una disposizione dei presenti Termini sia ritenuta invalida, illegittima o inapplicabile dall'autorita' competente, le restanti disposizioni rimarranno pienamente in vigore. La disposizione invalida sara' sostituita dalla disposizione legittima piu' prossima all'intento originario delle Parti.

### 23.3 Rinuncia (waiver)

Il mancato esercizio o il ritardato esercizio di un diritto previsto dai presenti Termini non costituisce rinuncia a tale diritto. Eventuali rinunce devono essere espresse per iscritto.
...
- Art. 24 (Contatti)
- Privacy Policy: in particolare conservazione dei log di audit e adempimento dei diritti dell'interessato
