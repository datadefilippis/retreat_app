...
export const MODES = [
  ...
  /* FM3 (22/8, founder: «falli tutti e 5») — geometria sacra,
     universo, onde: volumi di luce, mai fili */
  ['Flower','M12 5a4.2 4.2 0 1 0 .01 0M8.2 11.5a4.2 4.2 0 1 0 .01 0M15.8 11.5a4.2 4.2 0 1 0 .01 0'],
  ['Merkaba','M12 3l7.5 13h-15zM12 21l7.5-13h-15z'],
  ['Torus','M12 7c5.2 0 9 2.2 9 5s-3.8 5-9 5-9-2.2-9-5 3.8-5 9-5M12 10.2c2.6 0 4.6.8 4.6 1.8s-2 1.8-4.6 1.8-4.6-.8-4.6-1.8 2-1.8 4.6-1.8'],
  ['Ocean','M2 14c3.5-7 6.5-7 10 0 2.5 5 5 5 10-1M4 18c3-4.5 5.5-4.5 8 0'],
  ['Portal','M12 12m-2.2 0a2.2 2.2 0 1 0 4.4 0a2.2 2.2 0 1 0 -4.4 0M12 12m-5.2 0a5.2 5.2 0 1 0 10.4 0a5.2 5.2 0 1 0 -10.4 0M12 12m-8.2 0a8.2 8.2 0 1 0 16.4 0a8.2 8.2 0 1 0 -16.4 0'],
];
